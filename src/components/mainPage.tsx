              ...
              >
                ...
                >
                  ...
                  <Box display={"flex"}>
                    ...
                    >
                      <TypeAnimation
                        sequence={[
                          "I am a computer science engineer who specialize in frontend, my main working environment is React and HTML with CSS and TypeScript. Im also working in ExpressJS.",
                          50,
                        ]}
                      />
                    </Typography>
                  ...
                  >
                    <Button
                      variant={"outlined"}
                      onClick={() => handleExit("/education")}
                    >
                      Education
                    </Button>
                    <Button
                      variant={"outlined"}
                      onClick={() => handleExit("/myTechs")}
                    >
                      My techs
                    </Button>
                    <Button
                      variant={"outlined"}
                      onClick={() => handleExit("/projects")}
                    >
                      Projects
                    </Button>
                    <Button
                      variant={"contained"}
                      onClick={() => handleExit("/contact")}
                    >
                      Contact me
                    </Button>
                  </Box>
                  ...
                  >
                    ...
                    <Box
                      ...
                      width="4rem"
                      sx={{
                        backgroundImage: `url(${ExpressLogo})`,
                        backgroundRepeat: "no-repeat",
                        backgroundSize: "contain",
                      }}
                    />
                ...
                >
                  ...
                  <Box display={"flex"} gap={2} alignItems={"center"}>
                    ...
                    />
                    <Link
                      href={"https://github.com/MaciekMakowski"}
                      variant="h6"
                      underline={"none"}
                      target={"_blank"}
                    >
